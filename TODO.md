...
- [ ] **Test-Account `stripe-test-…@anprobierer-test.local` aufräumen**, sobald nicht mehr gebraucht (Supabase Dashboard → Authentication → Users) — samt seinem Test-Abo/Kunden in Stripe.
