const L = {
  ...
  'bar-chart-3':    '<path d="M3 3v18h18"/><path d="M7 16v-3"/><path d="M12 16v-7"/><path d="M17 16v-4"/>',
  ...
  'crown':          '<path d="M2 19h20v-2H2v2z"/><path d="M4 17 6 8l4 3 2-6 2 6 4-3 2 9H4z"/>',
  'download':       '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',
  'eye':            '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>',
  'eye-off':        '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/>',
  'file-text':      '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>',
  'flask':          '<path d="M3 3v18h18V3"/><path d="M7 8h10"/><path d="M10 3v6l-4 10"/><path d="M14 3v6l4 10"/>',
  ...
  'gem':            '<path d="M12 2 2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/>',
  ...
  'key':            '<path d="M15 4a5 5 0 1 1-4 2.18V10H9v2H7v2H4l-1 3h3v3h6v-4h1.36A5 5 0 0 0 15 4z"/><circle cx="15" cy="8" r="1"/>',
  'layers':         '<path d="m12 2 10 5-10 5-10-5z"/><path d="m2 7 10 5 10-5"/><path d="m2 12 10 5 10-5"/>',
  ...
  'shirt':          '<path d="M20.38 3.46 16 2.36a2 2 0 0 0-2.38.86l-1.62 2.7-1.62-2.7A2 2 0 0 0 8 2.36l-4.38 1.1A1 1 0 0 0 2.87 5.2l.77 7a1 1 0 0 0 1.11.85L8 12.6V21a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-8.4l3.25.35a1 1 0 0 0 1.11-.85l.77-7a1 1 0 0 0-.75-1.14z"/>',
...
export function icon(name, size = 16, strokeWidth = 2) {
  const path = L[name];
  if (!path) { console.warn(`[icons] unknown: "${name}"`); return ''; }
...
export function renderIconElements(root = document) {
  root.querySelectorAll('[data-lucide]').forEach(el => {
    ...
    const sw = el.getAttribute('data-sw') || '2';
    if (L[name]) {
      el.innerHTML = icon(name, +size, +sw);
    } else {
      console.warn(`[icons] unknown data-lucide: "${name}"`);
    }
  });
}
